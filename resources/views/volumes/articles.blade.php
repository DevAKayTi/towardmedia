...
@section('content')
<div class="content">
    @include('layouts.volumes.horizontalNav',['articles'=>'active'])

    <main>
        <!-- Dynamic Table Full -->
        <input type="hidden" name="volumeId" id="volumeId" value="{{$volume->id}}">
...
<script>
    $(document).ready(function() {
        ...
        $('#articles-table').DataTable({
            ...
            , autoWidth: false
            , ajax: {
                url: `/admin/volumes/${volumeId}/articles`
            }
            , columns: [{
                        data: 'DT_RowIndex'
                        , name: 'DT_RowIndex'
