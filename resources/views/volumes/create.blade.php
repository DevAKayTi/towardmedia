...
<div class="content">
    <div class="content content-full content-boxed">
        <!-- New Post -->
        <form action="{{route('volumes.store')}}" method="POST" id="store-volue-form">
            @csrf
            <div class="block">
                    ...
                    <div class="row justify-content-center push">
                        <div class="col-md-10">
                            <button type="submit" class="btn btn-alt-primary">
                                <i class="fa fa-fw fa-check opacity-50 me-1"></i> Create Volume
                            </button>
                        </div>
                    </div>
                </div>
...
{!! JsValidator::formRequest('App\Http\Requests\StoreVolumeRequest', '#store-volue-form'); !!}
