    ...
    <main id="">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title ">Posts (<span id="postCountDatatable">{{$publishedPosts}}</span>)</h3>
            </div>
            ...
            $('#posts-table').DataTable({
                ...
                , ajax: {
                    ...
                    , complete: function({
                        ...
                        $('#publishedPostsCount').text(recordsTotal)
                        $('#postCount').text(+$('#unpublishedPostsCount').text() + recordsTotal);
                    }
                }
                , columns: [{
                            data: 'DT_RowIndex'
