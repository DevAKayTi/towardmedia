    ...
    <div class="js-sidebar-scroll">
        ...
        <div class="content-side">
            <ul class="nav-main">
                ...
                <li class="nav-main-item {{ (request()->is('admin/volumes*') || request()->is('admin/bulletins*') ? 'open' : '')}}">
                    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                        <i class="nav-main-link-icon fa fa-thumbtack"></i>
                    ...
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ (request()->is('admin/bulletins*') ? 'active' : '')}}" href="{{route('bulletins.index')}}">
                                <span class="nav-main-link-name">All Bulletins </span>
                            </a>
                        </li>
                    </ul>
                </li>
