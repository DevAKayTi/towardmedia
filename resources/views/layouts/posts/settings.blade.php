                ...
                <div class="block mb-0">
                    ...
                    <div id="settings-accordion_s1" class="collapse show" role="tabpanel" aria-labelledby="settings-accordion_h1" data-bs-parent="#settings-accordion">
                        <div class="block-content">
                            ...
                            <div class="row mb-4 d-none " id="volume-row">
                                <label class="col-sm-4 col-form-label">Volume</label>
                                <div class="col-sm-8">
                                    <select class=" form-control @error('volume') is-invalid @enderror" id="volume" name="volume" style="width: 100%;">
                                        @foreach ($volumes as $volume)
                                        @if (old('volume') == $volume->id)
                ...
                <div class="block mb-0">
                    ...
                    <div id="settings-accordion_s4" class="collapse" role="tabpanel" aria-labelledby="settings-accordion_h4" data-bs-parent="#settings-accordion">
                        <div class="block-content">
                            <div class="mb-4">
                                {{old('featuredImage')}}
                                <input type="file" class="form-control dropify " data-max-file-size="5M" name="featuredImage" id="featuredImage" />
                                @error('featuredImage')
